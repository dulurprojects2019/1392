            ...
            <form role="form" method="post" enctype="multipart">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="Text" name="lvl_name" value="<?= $levels['lvl_name'] ?>" class="form-control <?= form_error('lvl_name') == TRUE ? 'is-invalid' : ''; ?>" id="exampleInputEmail1" placeholder="Enter Level Name">
