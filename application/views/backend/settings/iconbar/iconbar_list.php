        ...
        <div class="col-sm-6">
          <h3 class="card-title">
              <?php if (empty($iconbar)) : ?>
                <a href="<?= site_url('settings/'.$controllers.'/add') ?>" ><button type="button" class="btn btn-block btn-primary"><i class="fas fa-plus-square"></i> Add Icon Bar</button></a>
              <?php else : ?>
                <a href="#" ><button type="button" class="btn btn-block btn-primary" data-toggle="modal" data-target="#noiconbarimages"><i class="fas fa-plus-square"></i> Add Icon Bar</button></a>
              <?php endif; ?>
            </h3>
        </div>
        <div class="col-sm-6">
