            ...
            <form role="form" method="post" enctype="multipart/form-data">
              <div class="card-body">
                <div class="form-group">
                  <input type="Hidden" name="icb_id" value="<?= $iconbars['icb_id'] ?>">
                  <input type="Text" name="icb_name" value="<?= $iconbars['icb_name'] ?>" class="form-control <?= form_error('icb_name') == TRUE ? 'is-invalid' : ''; ?>" placeholder="Enter Iconbar Name *">
                  <a style="color: red;"><?= form_error('icb_name') ?></a>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    <div class="custom-file">
                      <input type="Hidden" name="photos" value="<?= $iconbars['icb_image'] ?>">
